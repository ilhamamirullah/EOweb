        ...
        <div class="box-body">
          <div class="row">
            <div class="container" style="max-width:100%;padding:30px 10px;">
             ...
             ?>
            	<form class="form-horizontal" role="form" action="<?php echo base_url();?>director/c_director/update_company" method="post">
                ...
                <div class="col-sm-8">
                  ...
                  <br>
                   ...
                   <a class="btn btn-danger" type="button" href="<?php echo base_url();?>director/c_director/company">Cancel</a>
            	   </div>
            	</form>
               <?php } ?>
            </div>
