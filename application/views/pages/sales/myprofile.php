...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo base_url(); ?>sales/c_sales/myprofile">My Profile</a></li>
    </ol>
  </section>
  <!-- Main content -->
            ...
            <form class="form-horizontal" autocomplete="off" role="form">
             ...
             <div class="col-sm-8">
               ...
               <div class="col-sm-offset-2 col-sm-8">
                  <a type="button" class="btn btn-success" href="<?php echo base_url();?>sales/c_sales/change_password">Change Password</a>
               </div>
            </form>
          </div>
        </div>
