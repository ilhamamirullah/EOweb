        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"> <a href="<?php echo base_url(); ?>admin/c_admin/print_record_book"  target="_blank" class="btn btn-warning btn-sm" >Print All</a> </h3>
              <!-- <h3 class="box-title"> <a href="<?php echo base_url(); ?>admin/c_admin/print_book_form/"  target="_blank" class="btn btn-success btn-sm" >Print Form</a> </h3> -->
