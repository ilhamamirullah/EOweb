...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo base_url(); ?>director/c_director/company">MyProfile</a></li>
      ...
      <div class="box-body">
        <div class="row">
          <div class="container" style="max-width:100%;padding:30px 10px;">
            <form class="form-horizontal" autocomplete="off" role="form" action="<?php echo base_url();?>director/c_director/change_password" method="post">
              ...
              <div class="col-sm-8">
               ...
               <div class="col-sm-offset-2 col-sm-8">
                  <button type="Submit" class="btn btn-success" href="<?php echo base_url();?>director/c_director/change_password">Ganti Password</button>
                  <button class="btn btn-warning" type="reset">Reset</button>
                  <a class="btn btn-danger" type="button" href="<?php echo base_url();?>director/c_director/myprofile">Cancel</a>
               </div>
            </form>
          </div>
        </div>
