        ...
        <div class="row">
          <div class="container" style="max-width:100%;padding:30px 10px;">
            <form class="form-horizontal" role="form" action="<?php echo base_url();?>sales/c_sales/add_company_save" method="post">
              ...
              <div class="col-sm-8">
                  <input type="design" class="form-control" id="design" name="design" placeholder="(standard/special)" required>
              ...
              <div class="col-sm-8">
                  <input type="notes" class="form-control" id="notes" name="notes" placeholder="Enter notes" required>
