        ...
        <div class="box-body">
          <div class="row">
            <div class="container" style="max-width:100%;padding:30px 10px;">
            	<form class="form-horizontal" autocomplete="off" role="form" action="<?php echo base_url();?>admin/c_admin/add_company_save" method="post">
                ...
                <div class="col-sm-8">
                  ...
                  <br>
            	   <div class="col-sm-offset-2 col-sm-8">
                    ...
                    <a class="btn btn-danger" type="button" href="<?php echo base_url();?>admin/c_admin/company">Cancel</a>
            	   </div>
            	</form>
            </div>
          </div>
