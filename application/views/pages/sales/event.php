        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"> <a href="<?php echo base_url(); ?>sales/c_sales/print_book/<?php echo $whereid; ?>"  target="_blank" class="btn btn-warning btn-sm" >Print All</a> </h3>
              <h3 class="box-title"> <a href="<?php echo base_url(); ?>sales/c_sales/print_book_form/<?php echo $whereid; ?>"  target="_blank" class="btn btn-success btn-sm" >Print Form</a> </h3>
